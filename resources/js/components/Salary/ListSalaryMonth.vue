<template>
    <div>
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">List Salary Month</h1>
            <ol class="breadcrumb">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr v-for="(e, index) in filterSearch" :key="e.salary_month">
                                ...
                                <td>
                                    <div class="btn-group">
                                        <router-link :to="{name: 'salaries.edit', params: {id: e.id}}" class="btn btn-primary">Edit</router-link>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
...
export default {
    ...
    methods: {
        fetch() {
            ...
            axios.get(`/salaries/by-month/${this.month}`, {headers: {Authorization: `Bearer ${token}`}})
                .then(res => {
